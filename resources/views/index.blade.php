                        ...
                        <div class="col-md-3">
                            <div class="dashboard-menu">
                                <ul class="nav flex-column" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="dashboard-tab" data-bs-toggle="tab" href=""
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="change-password-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="true"><i class="fi-rs-password mr-10"></i>Change Password</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body contact-from-area">
                                            <p>To track your order
                                                please enter your
                                                OrderID in the box below
                                                and press "Track"
                                                button. This was given
                                                to you on your receipt
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post" name="enq"
                                                action="{{ route('user.profile.store') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required class="form-control" value="{{ $userData->name }}"
                                                            name="name" type="text" id="name" />
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label>Email <span class="required">*</span></label>
                                                        <input required class="form-control"
                                                            value="{{ $userData->email }}" name="email" type="email"
                                                            id="email" />
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label>Phone
                                                            <span class="required">*</span></label>
                                                        <input required class="form-control"
                                                            value="{{ $userData->phone }}" name="phone" type="text"
                                                            id="phone" />
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label>Address
